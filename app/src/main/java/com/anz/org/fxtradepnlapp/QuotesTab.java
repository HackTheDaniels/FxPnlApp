...
//        });
        ...
        quotesListView = (ListView)quotesTabView.findViewById(R.id.quotesListView);
        //quotesListAdapter = new QuotesListAdapter(quotesTabView.getContext(), 0, );

        // setting list adapter
        quotesListView.setAdapter(quotesListAdapter);
